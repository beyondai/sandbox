...
Candidate 1 (round 1): give the model more boosting-round capacity
(max_iter=300) but let scikit-learn's own internal early stopping decide
when to actually stop, rather than a fixed low iteration count. Nothing
else changes.
"""
...
PROJECT_MODELING = HERE.parents[3]  # modeling/ (this file lives 4 levels
# below modeling/: modeling/autoresearch/rounds/round-0001/candidate-1/)
