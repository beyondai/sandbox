...
Round 2, candidate 1: try max_leaf_nodes=63 (larger trees per boosting
round) instead of the sklearn default of 31. Everything else identical.

Every round's candidates branch from a copy of this file. Paths are
relative to this file's own location
(modeling/autoresearch/rounds/round-0002/candidate-1/).
"""
