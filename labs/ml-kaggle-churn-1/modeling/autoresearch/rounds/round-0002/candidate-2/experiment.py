...
# candidate-2 is 4 levels under modeling/ (modeling/autoresearch/rounds/round-0002/candidate-2/);
# verified with a direct parents[] check that parents[4] lands on modeling/ (not parents[3]).
PROJECT_MODELING = Path(__file__).resolve().parents[4]  # modeling/
